...
class AskBot:
    def __init__(self, root):
        ...
        img = Image.open(r"V:\studie flies\SEM-6\Mini project-II\CODE files\Healthcare_Chatbot-main\Images\logo4_GPT-removebg.png")
...
###################################################################################################
        ...
        if self.nameask == 0:
            ...
            if msg.strip():
                ...
                if not self.disease_input:
                    ...
                    self.user_input.delete(0, "end")
                    self.display_message("Okay. For how many days have you been experiencing symptoms?", "bot")
                    ...
                    if msg.lower() == "yes":
                        ...
                        self.user_input.delete(0, "end")
                        self.display_message("Please hold on while I process your symptoms...", "bot")
                        self.tree_to_code(self.clf, self.cols, self.disease_input, self.num_days)
                        self.disease_input = ""
                        self.num_days = 0
                    else:
    ...
    def calc_condition(self, exp, days):
        ...
        if ((sum * days) / (len(exp) + 1) > 13):
            self.display_message("Based on the severity, it is advisable to consult a doctor.","bot")
        else:
